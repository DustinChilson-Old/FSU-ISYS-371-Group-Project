...
var gDocTable = new Array(
   new hrefList("slide0035.htm", 1, 1),
   new hrefList("slide0036.htm", 1, 2),
   ...
   new hrefList("slide0048.htm", 1, 14),
...
var g_baseURL = gtmpstr.substr(0, gtmpstr.lastIndexOf("/") ) + "/" + "Presentation_files";
var g_showoutline = 1;
  ...
  if ( (msie || isnav ) && ( (os < 0 && ver >= 4 ) || ( os >= 0 && ver >= 5 ) || (os >=0 && msie < 0 && ver >= 4 ) )  ){
	if ( msie >= 0 )  {
		if ( isIEFiles > 0 )
			...
			window.location.replace(  "Presentation_files/error.htm" );
	}
	else {
